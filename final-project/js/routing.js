import {QuakesController, Portfolio, Search, Home} from './QuakesController.js';

const routes = [
  {
    controller: new Home('#history'),
  ...
  {
    controller: new Search('#quakeList'),
    file: 'views/by-city.html',
    label: 'Search By City'
  },
  {
    controller: new Portfolio('#quakeList'),
...
export default function buildNavigation(parent) {
  routes.forEach(route => {
    ...
    // alert(stringify(route.controller))
